...
function timeSpanToString(startDate, endDate) {
  ...
  if (millisecs > 10 && millisecs < 100) millisecs = `0${millisecs}`;
...
function angleBetweenClockHands(date) {
  ...
  let degsBetween = Math.abs(0.5 * (60 * (hours % 12) - 11 * minutes));
  if (degsBetween > 180) degsBetween = 360 - degsBetween;
  degsBetween /= 180;
  return degsBetween * Math.PI;
}
